						...
						<div class="card">
							<div class="card-body">
								<div class="media align-items-center">
									<span class="mr-4">
										<div class="fa fa-thumbs-up fa-3x" style="color:#f48665 "></div>
									</span>
									<div class="media-body ml-1">
										<p class="mb-2">Total Interest</p>
										<h3 class="mb-0 text-black font-w600"><?=$i?></h3>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-sm-6">
						<div class="card">
							<div class="card-body">
								<div class="media align-items-center">
									<span class="mr-4">
										<div class="fa fa-list fa-3x" style="color:#f48665 "></div>

									</span>
									<div class="media-body ml-1">
										<p class="mb-2">Total Category </p>
										<h3 class="mb-0 text-black font-w600"><?=$c?></h3>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-sm-6">
						<div class="card">
							<div class="card-body">
								<div class="media align-items-center">
									<span class="mr-4">
										<div class="fa fa-list-alt fa-3x" style="color:#f48665 "></div>

									</span>
									<div class="media-body ml-1">
										<p class="mb-2">Total SubCategory </p>
										<h3 class="mb-0 text-black font-w600"><?=$s?></h3>
									</div>
								</div>
							</div>
						</div>

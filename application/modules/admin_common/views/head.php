...
<head>
	...
	<title>Dhired Admin</title>
	<!-- Favicon icon -->
	<link rel="icon" type="image/png" sizes="16x16" href="<?= base_url() ?>admin_assets/images/favicon.png">
	...
	<link href="<?= base_url() ?>admin_assets/vendor/summernote/summernote.css" rel="stylesheet">

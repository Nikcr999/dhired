...
<div class="nav-header">
	<a href="index.html" class="brand-logo">
		<img class="logo-abbr" src="<?=base_url()?>admin_assets/images/logo.png" alt="">
		<img class="logo-compact" src="<?=base_url()?>admin_assets/images/logo-text.png" alt="">
		<img class="brand-title" src="<?=base_url()?>admin_assets/images/logo-text.png" alt="">
	</a>
				...
				<ul class="navbar-nav header-right">
					...
					<li class="nav-item dropdown header-profile">
						<a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
							<img src="<?=base_url()?>admin_assets/images/profile/17.jpg" width="20" alt="" />
